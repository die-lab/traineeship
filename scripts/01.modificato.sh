...
genome_mit="NoGe_mit_doubled"
genome_mit_file="NoGe_mit.fasta"
#genome_nuc="NoGe_nuc"
#genome_nuc_file="NoGe_nuc.fna"

num_threads=12

#nella cartella dove faccio partire questo script ci devono essere anche ttti gli script ad esso associati, oltre che il genoma mitocondriale in fasta della specie analizzata (e le reads se non si hanno a disposizione i codici SRA).

SRA_entries="SRR8581407 SRR8581408 SRR8581409 SRR8581410"
...
sed 's/\/1//g' $output_fsed 's/\/1//g' $output_fa
